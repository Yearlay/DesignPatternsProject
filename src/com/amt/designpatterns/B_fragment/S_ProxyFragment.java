...
public class S_ProxyFragment extends Z_BaseFragment {
    ...
    protected View initView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ((TextView) rootView.findViewById(R.id.description)).setText("Proxy: use CustomerProxy to notify order.");
    ...
    protected void clickWidget(View view) {
        ...
        new ProjectFacade().buildTeam(getActivity(), mShowLayout).notifyOrderFromCustomer("Good Job! Nice!");
    }
